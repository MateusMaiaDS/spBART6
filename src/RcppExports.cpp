...
RcppExport SEXP _spBART6_log_dmvn(SEXP xSEXP, SEXP SigmaSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _spBART6_sum_exclude_col(SEXP matSEXP, SEXP exclude_intSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _spBART6_bspline(SEXP xSEXP, SEXP x_obsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type x(xSEXP);
...
RcppExport SEXP _spBART6_mat_init(SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _spBART6_vec_init(SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type n(nSEXP);
...
RcppExport SEXP _spBART6_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _spBART6_std_pinv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _spBART6_faster_simple_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _spBART6_faster_std_inv(SEXP ASEXP, SEXP diagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP _spBART6_rMVN2(SEXP bSEXP, SEXP QSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _spBART6_rMVNslow(SEXP bSEXP, SEXP QSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type b(bSEXP);
...
RcppExport SEXP _spBART6_matrix_mat(SEXP arraySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// rand_unif
double rand_unif();
RcppExport SEXP _spBART6_rand_unif() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_spBART6_log_dmvn", (DL_FUNC) &_spBART6_log_dmvn, 2},
    {"_spBART6_sum_exclude_col", (DL_FUNC) &_spBART6_sum_exclude_col, 2},
    {"_spBART6_bspline", (DL_FUNC) &_spBART6_bspline, 2},
    {"_spBART6_sbart", (DL_FUNC) &_spBART6_sbart, 27},
    {"_spBART6_mat_init", (DL_FUNC) &_spBART6_mat_init, 1},
    {"_spBART6_vec_init", (DL_FUNC) &_spBART6_vec_init, 1},
    {"_spBART6_std_inv", (DL_FUNC) &_spBART6_std_inv, 2},
    {"_spBART6_std_pinv", (DL_FUNC) &_spBART6_std_pinv, 2},
    {"_spBART6_faster_simple_std_inv", (DL_FUNC) &_spBART6_faster_simple_std_inv, 2},
    {"_spBART6_faster_std_inv", (DL_FUNC) &_spBART6_faster_std_inv, 2},
    {"_spBART6_rMVN2", (DL_FUNC) &_spBART6_rMVN2, 2},
    {"_spBART6_rMVNslow", (DL_FUNC) &_spBART6_rMVNslow, 2},
    {"_spBART6_matrix_mat", (DL_FUNC) &_spBART6_matrix_mat, 1},
    {"_spBART6_rand_unif", (DL_FUNC) &_spBART6_rand_unif, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_spBART6(DllInfo *dll) {
